...
def load_from_MSP(filename: str) :
    ...
    for pyteomics_spectrum in load_from_msp(filename):

        metadata = pyteomics_spectrum.metadata
        mz = pyteomics_spectrum.mz
        intensities = maxabs_scale(pyteomics_spectrum.intensities)
